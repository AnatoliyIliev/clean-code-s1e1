...
const completedTasksHolder = document.querySelector('.list_complet'); //completed-tasks
...
const createNewTaskElement = function (taskString) {
    ...
    label.classList.add('area-lable');
    ...
    editInput.type = 'text';
    editInput.classList.add('area-input');
...
const editTask = function () {
    ...
    const editInput = listItem.querySelector('.area-input');
    const label = listItem.querySelector('.area-lable');
    const editBtn = listItem.querySelector('.btn__edit');
    const containsClass = listItem.classList.contains('list__item__edit-mode');
...
//select ListItems children
    const checkBox = taskListItem.querySelector('.area-checkbox');
